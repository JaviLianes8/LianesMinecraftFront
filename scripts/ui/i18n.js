...
const MESSAGES = {
  es: {
    ...
    'ui.players.title': 'Jugadores en línea',
    'ui.players.loading': 'Esperando actualizaciones de jugadores…',
    'ui.players.empty': 'Sin jugadores conectados.',
    'ui.players.count.zero': 'Sin jugadores en línea',
    'ui.players.count.one': '1 jugador en línea',
    'ui.players.count.other': '{count} jugadores en línea',
    'ui.players.connectedSince': 'Conectado desde las {time}',
    'ui.players.connectedSinceWithDate': 'Conectado desde el {date} a las {time}',
  ...
  en: {
    ...
    'ui.downloads.neoforge': 'NeoForge',
    'ui.players.title': 'Players Online',
    'ui.players.loading': 'Waiting for player updates…',
    'ui.players.empty': 'No players connected.',
    'ui.players.count.zero': 'No players online',
    'ui.players.count.one': '1 player online',
    'ui.players.count.other': '{count} players online',
    'ui.players.connectedSince': 'Connected since {time}',
    'ui.players.connectedSinceWithDate': 'Connected since {date} {time}',
