...
const MESSAGES = {
  es: {
    ...
    'error.gatewayProxy': 'El proxy de la plataforma no pudo contactar con {destination} (HTTP {status}). Asegúrate de que el dominio resuelva públicamente y que el puerto esté accesible desde Internet.',
  ...
  en: {
    ...
    'error.gatewayProxy': 'The hosting proxy could not reach {destination} (HTTP {status}). Make sure the domain resolves publicly and that the port is reachable from the internet.',
