...
const MESSAGES = {
  es: {
    ...
    'ui.players.label': 'Jugadores conectados',
    'ui.players.empty': 'No hay jugadores conectados',
    'ui.players.connectedSince': 'Conectado desde {value}',
  ...
  en: {
    ...
    'ui.downloads.neoforge': 'NeoForge',
    'ui.players.label': 'Connected players',
    'ui.players.empty': 'No players connected',
    'ui.players.connectedSince': 'Connected since {value}',
